...
// import '../../../controllers/informations/new_doctor_controller.dart';
...
import '../../../utils/information_image.dart';
import '../../../view/Pages/informations/my_date_time.dart';
import '../../../view/widget/textfield_screen/my_app_bar.dart';
import '../../../view/widget/textfield_screen/my_drop_down_menu.dart';
                    ...
                    child: Form(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          const SizedBox(height: 15.0),
                          MyTextFormField(
                            controller: controller.AboutthedoctorController,
                            validator: (value) {
                              if (value == null || value.isEmpty) {
                                return 'Please enter the About The Doctor ';
                              }
                          ...
                          OnBoardingButton(
                            onPressed: () {
                              if (controller.formKey.currentState!.validate()) {
                                controller.formKey.currentState!.save();
                                // Get.to(NewExperiencesPage());
                                controller.registerDoctor(RegisterDoctorModel(
                                    centerId: '10',
                                    username:
                                    ...
                                    Aboutthedoctor: controller
                                        .AboutthedoctorController.text,
                                    comprehensiveprofiledoctors: controller
                                        .comprehensiveprofiledoctorsController
                                        .text,
                                    birthDate: controller.selectedDateOfBirth,
                                    YearsExperience: 2,
                                    experienceYears: 3,
                                    ...
                                    workEmail: controller.emailController.text,
                                    gender: controller.genderValue,
                                    nationality: controller.nationalityValue));
                              } else {
                                showDialog(
                                    context: context,
